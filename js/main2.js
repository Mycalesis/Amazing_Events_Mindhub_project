...
//vamos a conseguir los datos de nuestra api.
...
//             console.log(cajitas);
//             escuchadorDeCajitas();
//             console.log(escuchadorDeCajitas());
//             generateEventsCard(dataDeEventos.events);
//             filtroCruzado(dataDeEventos.events); 
...
//             return htmlPast += generateEventsCard(dataDeEventos);

//         } else {
//             return htmlFuture += generateEventsCard(dataDeEventos);
...
function filtroCruzado(eventosFiltrados) {   //pasar como parametro el array que sale de filtrar eventos por fecha   
